...
class PlayerImageUpdateNotifier extends StateNotifier<int> {
  PlayerImageUpdateNotifier() : super(0);
...
final playerImageUpdateProvider = StateNotifierProvider<PlayerImageUpdateNotifier, int>((ref) {
  return PlayerImageUpdateNotifier();
});